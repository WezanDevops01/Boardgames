...
if (
    ...
    $data['error_warning'] = sprintf(
        $this->language->get('error_min_cart_value'),
        $this->currency->format(
            $this->config->get('marketplace_min_cart_value'),
