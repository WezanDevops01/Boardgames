	...
	public function index() {
	 	$this->load->language('checkout/success');   
			...
			if (isset($this->session->data['order_id'])) {
               ...
               // Check if event_ids exists and is an array before trying to use it
				$cart_event_ids = (isset($this->session->data['event_ids']) && is_array($this->session->data['event_ids'])) ? $this->session->data['event_ids'] : []; 
                $products = $this->cart->getProducts();
                
                foreach ($cart_event_ids as $key => $cart_event_id) {
               ...
               // Add an isset check to prevent the Undefined Index notice
if(isset($this->session->data['random_strings']) && is_array($this->session->data['random_strings'])){
