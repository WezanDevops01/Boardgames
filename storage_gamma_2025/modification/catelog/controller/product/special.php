...
class ControllerProductSpecial extends Controller {
	public function index() {
        ...
        $data['products_daily'] = array();//daily product
		$data['products_weekly'] = array();//weekly product
		...
		$product_total = 5;
         ...
         $results_All = $this->model_catalog_product->getProductSpecials_All($filter_data);
        $results_Daily = $this->model_catalog_product->getProductSpecials_Daily($filter_data);
        $results_Weekly = $this->model_catalog_product->getProductSpecials_Weekly($filter_data);
		...
		$data['products_daily'] = $this->parseProducts($results_Daily);
		
		
			//weekly discount product
        ...
        $data['products_weekly'] = $this->parseProducts($results_Weekly);
	...
	private function parseProducts($results) {
		...
		foreach ($results as $result) {
			...
			if ($this->journal3->document->isDesktop() && ($additional_image = $this->journal3->productSecondImage($result))) {
