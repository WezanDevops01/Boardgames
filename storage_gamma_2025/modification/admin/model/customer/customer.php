...
$this->db->query("DELETE FROM " . DB_PREFIX . "hb_cart WHERE customer_id = '" . (int)$customer_id . "'");
	...
	public function getCustomerByEmail($email) {
		...
		return $query->row;
					...
					public function getGuestCustomers($data = array()) {
						$sql = "SELECT * FROM " . DB_PREFIX . "guest_newsletter ";
	...
	public function addTransaction($customer_id, $description = '', $amount = '', $order_id = 0) {
		    ...
		    $this->load->model('extension/hbapps/opencart_sms');
	        $this->model_extension_hbapps_opencart_sms->send_account_sms($customer_id, 'credit', $sms_data);
	...
	public function addReward($customer_id, $description = '', $points = '', $order_id = 0) {
		    ...
		    $this->load->model('extension/hbapps/opencart_sms');
	        $this->model_extension_hbapps_opencart_sms->send_account_sms($customer_id, 'reward', $sms_data);
