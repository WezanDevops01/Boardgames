...
class ControllerSaleDelivery extends Controller {
	...
	protected function getList() {
		...
		if (isset($this->request->get['filter_order_status'])) {
			$input_filter_order_status = $this->request->get['filter_order_status'];
		 // echo "Selected Delivery Status Name: " . $input_filter_order_status."<br>";
		} else {
			$input_filter_order_status = '';
		}
        ...
        foreach ($delivery_statuses as $status) {
            if ($status['name'] === $input_filter_order_status) {
                $delivery_status_id = $status['delivery_status_id'];
                break;
            }
        }

		//echo "<pre>";print_r($delivery_statuses);
	...
	//	echo "<pre>"; print_r($data['delivery_statuses']); die;
		...
		$data['delivery_status'] = $input_filter_order_status;
