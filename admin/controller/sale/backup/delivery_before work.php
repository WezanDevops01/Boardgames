...
class ControllerSaleDelivery extends Controller {
	...
	protected function getList() {
		...
		// ✅ Convert date format (handle DD/MM/YYYY or MM/DD/YYYY)
		...
		// Load the delivery status model
		$this->load->model('localisation/delivery_status');

		$delivery_status_id = null;

		// Case 1: Filter by a selected delivery status from a dropdown
		...
		// Case 2: Filter by a text input field
		elseif (!empty($filter_order_status_text)) {
			// Use the new model method to find the ID
		...
		$filter_data = array(
			...
			'filter_date_added'     => $filter_date_added,
			 'filter_delivery_status_name' => $input_filter_delivery_status_name, // from dropdown
			'filter_order_status_text' => $filter_order_status_text, // from text input
		...
		//echo "filter_start_date". $filter_start_date."<br>";
		//echo "filter_end_date". $filter_end_date."<br>";
		//echo "<pre>";print_r($filter_order_status_text);echo '</pre>';
		...
		// Pass the sort and order to the view for visual indication
		$data['sort'] = $sort;
		$data['order'] = $order;

		// Define sortable columns and generate their URLs
